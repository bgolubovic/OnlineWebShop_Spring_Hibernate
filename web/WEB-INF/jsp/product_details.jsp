...
<html>
    <head>
        ...
        <title>Detalji proizvoda | Gadgets Online Prodavnica</title>
    ...
    <body>
        <section>
            <center>
                <header>
                        <h1>Detalji proizvoda | Gadgets Online Prodavnica</h1> 
                        <nav>
                            <ul>
            ...
            <table>
                <tr>
                    <th>Ime proizvoda</th><th>Tip proizvoda</th><th>Cena</th><th>Boja proizvoda</th><th>Proizvođač</th><th>Memorija proizvoda</th><th>&nbsp;</th><th>&nbsp;</th>
                </tr>
                <c:forEach var="products" items="${products}">
                    <tr>
                        ...
                        <td>
                            $<c:out value="${products.getPrice()}"></c:out>
                        </td>
                        <td>

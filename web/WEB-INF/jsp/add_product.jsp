        ...
        <section>
            <center>
                <header>
                    ...
                    <h1>Dodaj novi proizvod | Administrator</h1>  
                    <nav>
                        <ul>
                ...
                <div id="buttons">
                    ...
                    <a href="add_product.htm" class="button blue small">Dodaj novi proizvod</a>
                ...
                <table id="add" style="width: 20%;">
                    <spring:nestedPath path="name">
                        <form:form method="POST" commandName="addproduct">
                            ...
                            <tr>
                                <td></td>
                                <td><input class="push_button red" type="submit" value="Dodaj proizvod"/></td>
                            </tr> 
                        </form:form>
                    </spring:nestedPath>
                </table>                
